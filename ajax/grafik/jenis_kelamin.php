    ...
    <div class="row" >
        ...
        <section class="col col-3">
           <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
            <input type="text" name="lname" placeholder="Tanggal Awal" class="datepicker" data-dateformat="dd/mm/yy">
        ...
        <section class="col col-3">
           <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
            <input type="text" name="lname" placeholder="Tanggal Akhir" class="datepicker" data-dateformat="dd/mm/yy">
            <b class="tooltip tooltip-top-left">
              <i class="fa fa-info txt-color-teal"></i> 
              Tanggal Akhir</b>
          </label>
...
<section id="widget-grid" class="">
    ...
    $('#3d-pie7').highcharts({
        ...
        title: {
            text: 'Grafik Laporan Jenis Kelamin'
        },
        tooltip: {
