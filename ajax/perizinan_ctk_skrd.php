...
<div class="row">
	<div class="col-sm-12">
	  ...
	  <div class="well">
			...
			<h1 class="semi-bold">B.6.  Apa itu "Cetak SKRD" ?</h1>
		<p class="text-justify">Pada halaman ini terdapat daftar suatu form cetak SKRD yang dilengkapi fitur pencarian data secara cepat untuk melakukan pencarian data pada sejumlah data yang banyak.</p>
	  </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Cetak SKRD</h4>				
			</div>
			<div class="modal-body no-padding">
				...
				<form action="" id="login-form" class="smart-form">
							...
							<fieldset>
								<section>
									<div class="row">
										<label class="label col col-3">Nomor SKRD</label>
										<div class="col col-5">
											<label class="input"> <i class="icon-append fa fa-list"></i>
												<input type="text" name="noSKRD">
											</label>
										</div>
									</div>
								</section>
								...
								<section>
									<div class="row">
										<label class="label col col-3">Tanggal SKRD</label>
										<div class="col col-5">
											<label class="input"> <i class="icon-append fa fa-calendar"></i>
						...
						<table id="dt_basic" class="table table-striped table-bordered smart-form" width="100%">
							<thead>
								<tr>
									...
									<th data-hide="phone,tablet,desktop">Lokasi Izin</th>
									<th data-hide="phone,tablet">Jenis Izin</th>
									<th data-hide="phone,tablet,desktop">Nomor SKRD</th>
