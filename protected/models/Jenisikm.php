 ...
 */
class Jenisikm extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('refjenisizinikm_id, refjenisizinikm_nama, refjenisizinikm_isaktif', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Jenisikm the static model class
	 */
