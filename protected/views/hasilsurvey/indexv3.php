					...
					<div id="form-identitas">
							...
							<div class="row">
								<div class="col col-sm-12 col-md-12 col-lg-12 text-center">
									<a class="btn btn-primary btn-lg" onclick="tampil_ikm()">Input IKM</a>
								</div>
							</div>
...
/*loadScript("<?php echo ASSETS_URL; ?>/js/plugin/jquery-form/jquery-form.min.js", runFormValidation);
	function runFormValidation() {
		var $orderForm = $("#form-input-data").validate({
				...
				messages : {
					namaresponden : {
						required : 'Mohon ketikan nama Anda'
					},
					jeniskelamin : {
					...
					usia : {
						required : 'Mohon isikan usia'
					},
					statuspendaftaran : {
						required : 'Mohon pilih status pendaftaran'
					},
					statusresponden : {
						required : 'Mohon pilih status responden'
					},
					tingkatpend : {
						required : 'Mohon pilih tingkat pendidikan'
					},
				},
	...
	function tampil_ikm () {
		if ($("#usia").val()=='' || $("#jeniskelamin").val()=='0' || $("#namaresponden").val() =='' || $("#jenisizin").val()=='0' || $("tingkatpend").val()=='0' || $("#statuspendaftaran").val()=='0' || $("#statusresponden").val()=='0') {
			$.SmartMessageBox({
			...
			$("#formpertanyaan").show('slow');
		}
	}
	function batalkan () {
		$("#form-identitas").slideDown('slow');
		$("#formpertanyaan").hide('slow');
	}
