...
<script type="text/javascript">
	...
	function simpan () {
		//alert("simpan");
		if ($(":radio:checked").length<<?php echo $data; ?> || $("#namaresponden").val()=='' ||  $("#usia").val()=='' || $("#jeniskelamin").val()==0 || $("#jenisizin option:selected").text()=='' || $("#masukan").val()=='' || $("tingkatpend").val()=='' || $("#statuspendaftaran").val()=='' || $("#statusresponden").val()=='') {
			$.SmartMessageBox({
				title : "Peringatan<br> Terdapat isian yang masih kosong, silakan lengkapi kembali", // judul Smart Alert
				content : "", // konten dari smart alert
				buttons : '[Ok]' // pengaturan tombol
