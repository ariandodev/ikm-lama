...
<form  id="jenis_kelamin" class="smart-form">
    <div class="row" >
        ...
        <section class="col col-3">
           <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
            <input type="date" id="tanggal_awal" name="lname" placeholder="Tanggal Awal" class="datepicker" data-dateformat="dd/mm/yy">
        ...
        <section class="col col-3">
           <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
            <input type="date" id="tanggal_akhir" name="lname" placeholder="Tanggal Akhir" class="datepicker" data-dateformat="dd/mm/yy">
            <b class="tooltip tooltip-top-left">
              <i class="fa fa-info txt-color-teal"></i> 
              Tanggal Akhir</b>
          </label>
    ...
    <footer class="demo-btns">
        <a><button class="btn btn-success pull-left" type="button" id="btncari">
    ...
    <div class="row">
        ...
        <article class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="jarviswidget" id="wid-id-table" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-sortable="false">
                ...
                <header>
                    <span class="widget-icon"> <i class="fa fa-bar-chart-o"></i> </span>
                    <h2>Grafik Laporan Jenis Kelamin</h2>                
    ...
    /*function untuk menggenerate chart*/
        function generate_chart(awal, akhir) {
            ...
            var options = {
                chart: {
                    type: 'pie',
                renderTo: '3d-pie7', // letak div chart
                options3d: {
                    enabled: true,
                    alpha: 45,
                    beta: 0
