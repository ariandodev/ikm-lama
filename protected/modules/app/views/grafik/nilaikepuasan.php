...
<h2>Pencarian Data Nilai IKM</h2>
<div class="well">
...
<section id="widget-grid" style="display:none" class="">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-3 col-md-3 col-lg-12">
        <h3 class="page-title txt-color-blueDark">
          <center>Grafik Nilai Kepuasan Masyarakat Tahun <?php echo date("Y"); ?><br></center>
        </h3>
      </div>
    </div>
    <hr>
    <div class="row">
        ...
        <article class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="jarviswidget" id="wid-id-8023471" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-sortable="false">
                ...
                <header>
                    ...
                    <h2>Laporan Nilai Kepuasan Masyarakat</h2>                
        ...
        <article class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <!-- Widget ID (each widget will need unique ID)-->
            <div class="jarviswidget" id="wid-id-9812346" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-sortable="false">
                <!-- widget options:
                    usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
                ...
                <header>
                    <span class="widget-icon"> <i class="fa fa-bar-chart-o"></i> </span>
                    <h2>Grafik Laporan Nilai Kepuasan Masyarakat</h2>                
    ...
    /*function untuk menggenerate chart*/
        function generate_chart(tahun, izin) {
            ...
            var options = {
                ...
                title: {
                    text: 'Grafik Laporan Nilai Kepuasan Masyarakat' //judul chart
                },
                /*tooltip: {
            ...
            $.getJSON('app/grafik/AjxGrfNilaiIkm', {
                tahun : tahun,
                jenis_izin : izin
            }, function(data) {
            ...
            $('#grfcetak').click(function() {
                    var chart = new Highcharts.Chart(options);
                    chart.exportChart({type: 'application/pdf', filename: 'grafiknilaikepuasan'}, {subtitle: {text:''}});
                });
        }
        ...
        function getTabel(tahun,izin) {
            $.ajax({
                url: 'app/grafik/GetTabelNilaiIkm',
                type: 'POST',
                dataType: 'html',
        ...
        function getTotal(tahun,izin) {
            $.ajax({
                url: 'app/grafik/GetTotalNilaiIkm',
                type: 'POST',
                data: {tahun: tahun,jenis_izin: izin},
                success : function (respon) {
        ...
        function cetak (tipe) {
            ...
            var tahun = $("#tahun").val();
            window.open('<?php echo Yii::app()->getbaseUrl(true); ?>/app/grafik/CetakNilaiIkm?tipe='+tipe+"&tahun="+tahun+"&jenis_izin="+jenis_izin);
          }
