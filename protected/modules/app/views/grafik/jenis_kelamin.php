...
<h2>Pencarian Data Jumlah Responden per Jenis Kelamin</h2>
<div class="well">
...
<section id="widget-grid-kelamin" style="display:none" class="">
    <!-- row -->
    <div class="row">
      <div class="col-xs-12 col-sm-3 col-md-3 col-lg-12">
        <h3 class="page-title txt-color-blueDark">
          <center>Laporan Jumlah Responden per Jenis Kelamin Tahun <?php echo date("Y"); ?></center>
        </h3>
      </div>
    </div>
    <hr>
    <div class="row">
        ...
        <article class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div class="jarviswidget" id="wid-id-grafik1-kelamin" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-sortable="false">
                <!-- widget options:
                ...
                <header>
                    ...
                    <h2>Tabel Jumlah Responden per Jenis Kelamin</h2>                
        ...
        <article class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <!-- Widget ID (each widget will need unique ID)-->
            <div class="jarviswidget" id="wid-id-table-grafik-kelamin-bla-bla" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-sortable="false">
                <!-- widget options:
                    usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
                ...
                <header>
                    <span class="widget-icon"> <i class="fa fa-bar-chart-o"></i> </span>
                    <h2>Grafik Jumlah Responden per Jenis Kelamin</h2>                
                ...
                <div>
                    ...
                    <div class="widget-body-toolbar">
                        ...
                        <div id="grafik-jenis-kelamin" class="chart has-legend" style="height:300px; width: 100%; margin: 0px;"></div>   
                    </div>
                    <!-- end widget content -->
    ...
    /*function untuk menggenerate chart*/
        function generate_chart(awal, akhir) {
            ...
            var options = {
                chart: {
                    type: 'pie',
                renderTo: 'grafik-jenis-kelamin', // letak div chart
                options3d: {
                    enabled: true,
                    alpha: 45,
                    beta: 0
                ...
                title: {
                    text: 'Grafik Laporan Jenis Kelamin' //judul chart
                },
                tooltip: {
            ...
            $.getJSON('app/grafik/AjxGrfJenisKelamin', {
                tanggal_awal : awal,
                tanggal_akhir : akhir
            }, function(data) {
            ...
            $('#grfcetak').click(function() {
                    var chart = new Highcharts.Chart(options);
                    chart.exportChart({type: 'application/pdf', filename: 'grafikjeniskelamin'}, {subtitle: {text:''}});
                });
        }
        ...
        function getTabel(awal,akhir) {
            $.ajax({
                url: 'app/grafik/GetTableJenisKelamin',
                type: 'POST',
                data: {tanggal_awal: awal,tanggal_akhir: akhir},
                success : function (respon) {
                    $("#tabel_jeniskelamin").html(respon);
                    $("#widget-grid-kelamin").show();
                }
            });
        }
        ...
        function getTotal(awal,akhir) {
            $.ajax({
                url: 'app/grafik/GetTotalJenisKelamin',
                type: 'POST',
                data: {tanggal_awal: awal,tanggal_akhir: akhir},
                success : function (respon) {
                    $("#totalb").html(respon);
        ...
        function cetak (tipe) {
            ...
            window.open('<?php echo Yii::app()->getbaseUrl(true); ?>/app/grafik/CetakJenisKelamin?tipe='+tipe+"&tanggal_awal="+tanggal_awal+"&tanggal_akhir="+tanggal_akhir);
          }
        ...
        function runFormValidation() {
            var $FormDaftar = $("#jenis_kelamin").validate({
