<h2>Pencarian Data IKM Per Jenis Izin</h2>
<form id="form_cari">
            ...
            <section class="col-md-5">
              <div>
                <select class="form-control" id="jenis_izin" name="jenis_izin"  type="text">
                  ...
                  <?php foreach ($combojenisizin as $list) : ?>
                    <option value="<?php echo $list['refjenisizinikm_id'] ?>"><?php echo $list['refjenisizinikm_nama'] ?></option>
                  <?php endforeach ?>
                </select>
              </div>
            </section>
...
<script type="text/javascript">
      ...
      function tampil() {
        if ($("#tahun").val()=='' || $("#bulan").val()=='') {
          ...
          notifikasi('Informasi','Mohon pilih Tahun dan Bulan','failed',1,0);
        }
        else{
          ...
          $.ajax({
            url: 'app/laporan/GetDataLaporan',
            type: 'POST',
            data: {
              tahun: $("#tahun").val(),
              bulan: $("#bulan").val(),
