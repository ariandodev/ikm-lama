<style type="text/css">
  ...
  table.tableikm tr {
    ...
    <h3 align="center" class="page-title txt-color-blueDark">
    Hasil Rekapitulasi Survey Kepuasan Masyarakat Pelayanan Perizinan <?php echo $bulan; ?> <?php echo $tahun; ?>
    </h3>
...
<table border="1" class="tableikm" cellspacing="5" cellpadding="5" align="center" width="100%">
    <thead>
            <tr>
              <th rowspan="2" data-class="expand"><div align="center">No</div></th>
              <th rowspan="2" data-class="phone"><div align="center">Unsur Pelayanan </div></th>
...
<p align="center">KETERANGAN :<br>
  ...
  <center><table border="1" width="100%" class="tbleikm">
  <thead>
    <tr>
