      		...
      		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      			...
      			<div class="jarviswidget jarviswidget-color-greenDark" id="wid-id-1" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false">
      			    ...
      			    <header>
        				  ...
        				  <h2><?php echo $izin['refjenisizinikm_nama'];?>
      					  <!-- widget div-->
      				    </h2>
      				  </header>
      				<div>
                    ...
                    <button class="btn btn-warning" onclick="cetak('html')"><i class="fa fa-print"></i> Cetak</button>
                          ...
                          <thead>
                            <tr>
                              ...
                              <th rowspan="2" data-hide="phone"><div align="center">Unsur Pertanyaan </div></th>
                         ...
                         //print_r($jml_kosong);
                           ...
                           <!-- <tfoot>
                              <tr>
                                <td colspan="14"><div align="center">Jumlah responden s/d  2014</div></td>
                                <td>1.064</td>
                              </tr>
                            </tfoot> -->
                  </table>
...
<script type="text/javascript">
  ...
  function cetak (tipe) {
    ...
    window.open('<?php echo Yii::app()->getbaseUrl(true); ?>/app/laporan/CetakResponden?tipe='+tipe+"&tahun="+tahun+"&jenis_izin="+jenis_izin+"&bulan="+bulan);
  }
