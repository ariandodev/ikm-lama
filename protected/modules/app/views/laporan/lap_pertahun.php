  ...
  <div class="row" >
    ...
    <div class="well" style="padding: 1px;">
      <h1 align="center" class="page-title txt-color-blueDark">
        Hasil Akhir Indeks Kepuasan Masyarakat <?php echo $bulan;?> <?php echo $tahun;?></h1>
    </div>
...
<script type="text/javascript">
  ...
  function cetak (tipe) {
    var tahun=$("#tahun").val();
    var bulan=$("#bulan").val();
    window.open('<?php echo Yii::app()->getbaseUrl(true); ?>/app/laporan/CetakPertahun?tipe='+tipe+"&tahun="+tahun+"&bulan="+bulan);
  }
