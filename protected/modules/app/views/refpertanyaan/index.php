...
<section id="widget-grid" class="">
    ...
    <div class="row">
        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            ...
            <!-- widget div-->
            <div style="display:none" id="form-pertanyaan">
                    ...
                    <div id="attachement" style="padding: 20px;">
                            ...
                            <div class="row" >
                                ...
                                <section class="col col-5">
                                   <input class="form-control" placeholder="Nomor Urut" id="nomor_urut" type="text">
                                </section>
                            </div>
                            <div class="row">
                                 <section class="col col-1">
                                ...
                                <section class="col col-5">
                                   <label class="textarea"> <i class="icon-append fa fa-question-circle"></i>                             
                                    <textarea rows="3" placeholder="" id="pertanyaan_uraian"></textarea>
                            ...
                            <section class="col col-2">
                                 <input class="form-control" placeholder="" type="text" id="jawaban_a">
                            </section>
                            </div>
                            ...
                            <section class="col col-2">
                                 <input class="form-control" placeholder="" type="text" id="jawaban_b">
                            </section>
                            </div>
                            ...
                            <section class="col col-2">
                                 <input class="form-control" placeholder="" type="text" id="jawaban_c">
                            </section>
                            </div>
                            ...
                            <section class="col col-2">
                                 <input class="form-control" placeholder="" type="text" id="jawaban_d">
                            </section>
                            </div>
                        ...
                        <footer>
                            ...
                            <header>
                                ...
                                <div>
                                    ...
                                    <tbody>
                                    	<php <?php foreach ($datapertanyaan as $pertanyaan): ?>
                                    		
                               
                                        <tr class="odd gradeX">
                                            <td><?php echo $pertanyaan['tblpertanyaan_urut'];?></td>
                                            <td><?php echo $pertanyaan['tblpertanyaan_uraian'];?></td>
                                            <td><?php echo $pertanyaan['tblpertanyaan_ketjawabanA'];?> </td>
                                            <td><span class="pull-left"><?php echo $pertanyaan['tblpertanyaan_ketjawabanB'];?></span></td>
                                            <td><span class="pull-left"><?php echo $pertanyaan['tblpertanyaan_ketjawabanC'];?> </span></td>
                                            <td><span class="pull-left"><?php echo $pertanyaan['tblpertanyaan_ketjawabanD'];?></span></td>
                                        	<td><button onclick="edit(<?php echo $pertanyaan['tblpertanyaan_id']; ?>)" type="button" class="btn btn-labeled btn-success btn-sm" style="width:65px; height:30px;">
								    		
										    			<i class="fa fa-edit"></i>
										    		Edit
										    	</button>

										    	<button  onclick="hapus(<?php echo $pertanyaan['tblpertanyaan_id']; ?>)" type='button' class='btn btn-labeled btn-danger btn-sm' style="width:65px; height:30px;">
...
function simpan () {
		//$("#eg7").click();
		$.ajax({
			url: 'app/refpertanyaan/simpan',
			type: 'POST',
			data: {
				cmd: window.cmd,
				id: window.id,
				nomor_urut: $('#nomor_urut').val(),
				pertanyaan_uraian: $('#pertanyaan_uraian').val(),
...
function edit(id) {
	...
	window.cmd = "edit";
	$.ajax({
		url: 'app/refpertanyaan/GetDataPertanyaan',
		type: 'POST',
		data: {id: id},
		success : function (respon) {
			$("#nomor_urut").val(respon.nomor);
			$("#pertanyaan_uraian").val(respon.pertanyaan);
			$("#jawaban_a").val(respon.jawabanA);
			$("#jawaban_b").val(respon.jawabanB);
			$("#jawaban_c").val(respon.jawabanC);
			$("#jawaban_d").val(respon.jawabanD);
...
function hapus(id) {
	...
	$.ajax({
		url: 'app/refpertanyaan/HapusDataPertanyaan',
		type: 'POST',
		data: {id: id},
			success: function  (respon) {
				if (respon=='success') 
